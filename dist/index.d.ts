 ...
 */
export declare const requestPermission: (
 ...
 */
export declare const getCurrentPermission: () => Promise<
  LocationPermissionStatus
>;
/**
 ...
 */
export declare const subscribeToPermissionUpdates: (
 ...
 * @returns {Subscription} The subscription function which can be used to unsubscribe.
 */
export declare const subscribeToLocationUpdates: (
 ...
 */
export declare const getLatestLocation: (
 ...
 * @returns {Subscription} The subscription function which can be used to unsubscribe.
 */
export declare const subscribeToHeadingUpdates: (
 ...
 * @returns {Subscription} The subscription function which can be used to unsubscribe.
 */
export declare const subscribeToSignificantLocationUpdates: (
  listener: (locations: Location[]) => void
) => Subscription;
