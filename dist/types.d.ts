export declare type LocationPermissionStatus =
  | "authorizedAlways"
  | "authorizedWhenInUse"
  | "authorizedFine"
  | "authorizedCoarse"
 ...
 */
export declare type LocationActivityType =
  | "other"
 ...
 */
export declare type LocationPriorityAndroid =
 ...
 */
export declare type LocationAccuracyIOS =
  | "bestForNavigation"
  | "best"
  | "nearestTenMeters"
  | "hundredMeters"
 ...
 */
export declare type HeadingOrientation =
  | "portrait"
  | "portraitUpsideDown"
  | "landscapeLeft"
  | "landscapeRight";
